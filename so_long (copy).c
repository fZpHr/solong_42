...
//    if (background_ptr == NULL) {
  //      fprintf(stderr, "Erreur : Impossible de charger l'image de fond.\n");
   ...
   // }
	...
	player_ptr_s1 = mlx_png_file_to_image(mlx_ptr, "/nfs/homes/hbelle/42/Projet/Project_solong/image/chara/char_run_down_0.png", &width, &height);
	if (!player_ptr_s1)
		return(printf("ALED"));
	player_ptr_s2 = mlx_png_file_to_image(mlx_ptr, "/nfs/homes/hbelle/42/Projet/Project_solong/image/chara/char_run_down_0.png", &width, &height);
	...
	player_ptr_w1 = mlx_png_file_to_image(mlx_ptr, "/nfs/homes/hbelle/42/Projet/Project_solong/image/chara/char_run_up_0.png", &width, &height);
	...
	player_ptr_d1 = mlx_png_file_to_image(mlx_ptr, "/nfs/homes/hbelle/42/Projet/Project_solong/image/chara/char_run_right_0.png", &width, &height);
	...
	player_ptr_a1 = mlx_png_file_to_image(mlx_ptr, "/nfs/homes/hbelle/42/Projet/Project_solong/image/chara/char_run_left_0.png", &width, &height);
  ...
  //  mlx_put_image_to_window(mlx_ptr, win_ptr, backgrounD_ptr, 0, 0);
    ...
    mlx_loop_hook(win_ptr, handle_input, mlx_ptr);
