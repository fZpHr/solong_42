...
/*   Updated: 2023/12/20 14:24:48 by hbelle           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_player_sprites_enemy(t_game *g)
{
	g->enemy_sprites[0][0] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/1.xpm", &g->width, &g->height);
	g->enemy_sprites[0][1] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/2.xpm", &g->width, &g->height);
	g->enemy_sprites[0][2] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/3.xpm", &g->width, &g->height);
	g->enemy_sprites[0][3] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/4.xpm", &g->width, &g->height);
	g->enemy_sprites[0][4] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/5.xpm", &g->width, &g->height);
	g->enemy_sprites[0][5] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/6.xpm", &g->width, &g->height);
	g->enemy_sprites[1][0] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/1r.xpm", &g->width, &g->height);
	g->enemy_sprites[1][1] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/2r.xpm", &g->width, &g->height);
	g->enemy_sprites[1][2] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/3r.xpm", &g->width, &g->height);
	g->enemy_sprites[1][3] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/4r.xpm", &g->width, &g->height);
	g->enemy_sprites[1][4] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/5r.xpm", &g->width, &g->height);
	g->enemy_sprites[1][5] = mlx_xpm_file_to_image(g->mlx_ptr,
			"./image/enemy/6r.xpm", &g->width, &g->height);
}
