...
/*   Updated: 2023/12/20 16:58:42 by hbelle           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/so_long.h"

void	render_wall_or_floor(t_game *g)
{
	if (g->line[g->i] == '1')
	{
...
void	render_object_or_door(t_game *g)
{
	if (g->line[g->i] == 'C')
	{
...
int	render_loop(t_game *g)
{
	while (g->line[g->i])
	{
		if (g->line[g->i] == '1' || g->line[g->i] == '0')
			render_wall_or_floor(g);
		else if (g->line[g->i] == 'C' || g->line[g->i] == 'E')
			render_object_or_door(g);
